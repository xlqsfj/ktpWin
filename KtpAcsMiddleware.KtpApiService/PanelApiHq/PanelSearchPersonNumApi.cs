...
{
    public class PanelSearchPersonNumApi : ApiBase<PanelSearchSend, HqResult>
    {
        public PanelSearchPersonNumApi()
         : base()
        {


            base.API = "/action/SearchPersonNum";
        ...
        protected override PushSummary OnPushSuccess(RichRestRequest request, HqResult receiveData)
        {
           string  isSuccess=   receiveData.info.Result;
            PushSummary mag = new PushSummary(isSuccess== "Fail"?false:true , receiveData.info.Detail, ApiType.Panel, request, "闸门面板人员查询列表接口");
