...
{
  public   class PanelGetSysParamApi : ApiBase<dynamic, HqResult>
    {
        public PanelGetSysParamApi()
         : base()
        {


            base.API = "/action/GetSysParam";
        ...
        protected override PushSummary OnPushSuccess(RichRestRequest request, HqResult receiveData)
        {
            ...
            PushSummary mag = new PushSummary(isSuccess == "Fail" ? false : true, receiveData.info.Detail, ApiType.Panel, request, "闸门面板系统查询接口");
