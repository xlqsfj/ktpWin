...
{
    public class PanelHqDeleteAllPersonApi : ApiBase<DeleteSend, HqResult>
    {
        public PanelHqDeleteAllPersonApi()
          : base()
        {


            base.API = "/action/SetFactoryDefault";
        ...
        protected override PushSummary OnPushSuccess(RichRestRequest request, HqResult receiveData)
        {
            ...
            PushSummary mag = new PushSummary(isSuccess == "Fail" ? false : true, receiveData.info.Detail, ApiType.Panel, request, "闸门面板全部人员删除接口");
