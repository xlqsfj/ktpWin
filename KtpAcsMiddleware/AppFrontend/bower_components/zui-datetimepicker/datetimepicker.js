...
! function($) {
    ...
    var Datetimepicker = function(element, options) {
        ...
        this.language = (options.language ||
            this.element.data("date-language") ||
            ($.zui && $.zui.clientLang ? $.zui.clientLang().replace("_", "-") : "zh-cn")).toLowerCase();
        ...
        this.component = this.element.is(".date")
            ? this.element
            .find(".input-group-addon .icon-th, .input-group-addon .icon-time, .input-group-addon .icon-calendar")
            .parent()
            : false;
        this.componentReset = this.element.is(".date")
            ? this.element.find(".input-group-addon .icon-remove").parent()
            : false;
    ...
    Datetimepicker.prototype = {
        ...
        place: function() {
            ...
            var realPickerPosition = isAutoPosition
                ? (((offset.top + this.picker.outerHeight() > $(window).height() + $(window).scrollTop())
                        ? "top"
                        : "bottom") +
                    (this.pickerPosition.lastIndexOf("-left") === 0 ? "-left" : "-right"))
                : this.pickerPosition;
        ...
        return this.each(function() {
            ...
            if (!data) {
                $this.data("datetimepicker",
                    (data = new Datetimepicker(this,
                        $.extend({}, $.fn.datetimepicker.defaults, $this.data(), options))));
            }
