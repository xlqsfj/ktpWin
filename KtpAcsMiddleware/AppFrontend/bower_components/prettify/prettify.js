...
!function() {
    ...
    (function() {
        function S(a) {
            ...
            function b(e) {
                var b = e.substring(1, e.length - 1)
                ...
                for (var a = a ? 1 : 0, f = b.length; a < f; ++a) {
                    ...
                    if (/\\[bdsw]/i.test(h)) c.push(h);
                        ...
                        l < 65 ||
                            h > 122 ||
                            (l < 65 || h > 90 || e.push([Math.max(65, h) | 32, Math.min(l, 90) | 32]), l < 97 ||
                                h > 122 ||
            ...
            function s(e) {
                ...
                if (e.ignoreCase && m)
                    for (f = 0; f < c; ++f)
                        l = a[f], e = l.charAt(0), l.length >= 2 && e === "["
                            ? a[f] = b(l)
                            : e !== "\\" &&
                            (a[f] = l.replace(/[A-Za-z]/g,
                                function(a) {
                                    a = a.charCodeAt(0);
        ...
        function C(a, d) {
            function g(a) {
                for (var j = a.e, k = [j, "pln"], c = 0, i = a.a.match(s) || [], r = {}, n = 0, e = i.length;
                    n < e;
                    ++n) {
        ...
        function J(a, d, g) {
                ...
                if (c == 1 && !x.test(a.className))
                    ...
                    if (i)
                        c = d.substring(0, i.index), a.nodeValue =
                            ...
                            a.parentNode.insertBefore(j.createTextNode(d), a.nextSibling), s(a), c ||
            ...
            for (var d = Math.max(0, d - 1 | 0) || 0, i = 0, n = c.length; i < n; ++i)
                k = c[i], k.className =
                    "L" + (i + d) % 10, k.firstChild || k.appendChild(j.createTextNode("\u00a0")), r.appendChild(k);
            a.appendChild(r);
        }
                ...
                try {
                    for (; b < k;) {
                        ...
                        (G = x.substring(g,
                            ...
                            o.appendChild(A);
                            g < l &&
                                (j[b + 1] = A = L.createTextNode(x.substring(t, l)), v.insertBefore(A, o.nextSibling));
                        }
                        g = t;
                        g >= l && (b += 2);
                        g >= B && (r += 2);
        ...
        var Y = D.PR = {
            ...
            prettyPrint: D.prettyPrint = function(a, d) {
                ...
                for (var b = d || document.body,
                    ...
                    m = 0;
                    m < b.length;
                    ++m) for (var j = 0, k = b[m].length; j < k; ++j) p.push(b[m][j]);
                var b = q, c = Date;
