                        ...
                        if (innermostIntersecting) {
                            ...
                            if (!this.instance.isOver) {
                                ...
                                this.instance.currentItem =
                                    $(that).clone().removeAttr("id").appendTo(this.instance.element)
...
(function($, undefined) {
    ...
    $.ui.intersect = function(draggable, droppable, toleranceMode) {
        ...
        case "intersect":
            ...
            break;
        case "pointer":
            var draggableLeft = ((draggable.positionAbs || draggable.position.absolute).left +
                ...
                for (var i = 0; i < this._proportionallyResizeElements.length; i++) {
                    ...
                    if (!this.borderDif) {
                        var b = [
                            ...
                            p = [
                                prel.css("paddingTop"), prel.css("paddingRight"), prel.css("paddingBottom"),
                                prel.css("paddingLeft")
                            ];

                        this.borderDif = $.map(b,
                            function(v, i) {
        ...
        "animate",
        {
            stop: function(event, ui) {
                ...
                var pr = that._proportionallyResizeElements,
                    ista = pr.length && (/textarea/i).test(pr[0].nodeName),
                    soffseth =
                        ista && $.ui.hasScroll(pr[0], "left") /* TODO - jump height */ ? 0 : that.sizeDiff.height,
                    soffsetw = ista ? 0 : that.sizeDiff.width;
...
//Where the click happened, relative to the element
                ...
                for (var i = this.items.length - 1; i >= 0; i--) {
                    ...
                    if (itemElement != this.currentItem[0] //cannot intersect with itself
                            ...
                            !$.contains(this.placeholder[0],
                                itemElement) //no action if the item moved is the parent of the item checked
                            &&
            ...
            _intersectsWithSides: function(item) {
                ...
                var isOverBottomHalf = $.ui.isOverAxis(this.positionAbs.top + this.offset.click.top,
                        item.top + (item.height / 2),
                        item.height),
                    isOverRightHalf = $.ui.isOverAxis(this.positionAbs.left + this.offset.click.left,
    ...
    $.extend($.ui.dialog.overlay,
        {
            ...
            create: function(dialog) {
                ...
                $(document).bind("keydown.dialog-overlay",
                    function(event) {
