...
!function(a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        version: "5.0.0",
        htmlDecode: function(a) { return a && ("&nbsp;" === a || "&#160;" === a || 1 === a.length && 160 === a.charCodeAt(0)) ? "" : a ? String(a).replace(/&gt;/g, ">").replace(/&lt;/g, "<").replace(/&quot;/g, '"').replace(/&amp;/g, "&") : a; },
        htmlEncode: function(a) { return a ? String(a).replace(/&/g, "&amp;").replace(/\"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : a; },
        template: function(a) {
        ...
        parseDate: function(a, b, c, d) {
            var e, f, g, h = /\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g, i = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, j = /[^-+\dA-Z]/g, k = new RegExp("^/Date\\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\\)/$"), l = "string" == typeof b ? b.match(k) : null, m = function(a, b) {
                ...
                return a;
            }, n = { m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0 }, o = 0, p = function(a, b) { return 0 === a ? 12 === b && (b = 0) : 12 !== b && (b += 12), b; }, q = 0;
        ...
        jqID: function(a) { return String(a).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g, "\\$&"); },
        guid: 1,
        uidPref: "jqg",
        randId: function(a) { return (a || $.jgrid.uidPref) + $.jgrid.guid++; },
        ...
        from: function(source) {
            var $t = this, QueryObject = function(d, q) {
                ...
                return d.length > 0 && (_useProperties = "object" != typeof d[0] ? !1 : !0), this._hasData = function() { return null === _data ? !1 : 0 === _data.length ? !1 : !0; }, this._getStr = function(a) {
                    var b = [];
                    return _trim && b.push("jQuery.trim("), b.push("String(" + a + ")"), _trim && b.push(")"), _usecase || b.push(".toLowerCase()"), b.join("");
                }, this._strComp = function(a) { return "string" == typeof a ? ".toString()" : ""; }, this._group = function(a, b) { return { field: a.toString(), unique: b, items: [] }; }, this._toStr = function(a) { return _trim && (a = $.trim(a)), a = a.toString().replace(/\\/g, "\\\\").replace(/\"/g, '\\"'), _usecase ? a : a.toLowerCase(); }, this._funcLoop = function(a) {
                    var b = [];
                    ...
                    } : "int" === d || "integer" === d ? function(a) { return a ? parseFloat(String(a).replace(_stripNum, "")) : Number.NEGATIVE_INFINITY; } : "date" === d || "datetime" === d ? function(a) { return $.jgrid.parseDate.call($t, e, a).getTime(); } : $.isFunction(d) ? d : function(a) { return a = a ? $.trim(String(a)) : "", _usecase ? a : a.toLowerCase(); }, $.each(a, function(a, c) { h = "" !== b ? $.jgrid.getAccessor(c, b) : c, void 0 === h && (h = ""), h = j(h, c), l.push({ vSort: h, index: a }); }), l.sort($.isFunction(f) ? function(a, b) { return a = a.vSort, b = b.vSort, f.call(this, a, b, m); } : function(a, b) { return a = a.vSort, b = b.vSort, self._compare(a, b, m); }), i = 0;
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function(a, b) { return a = parseInt(a, 10), isNaN(a) ? b || 0 : a; }, z = function(a, b, c, f, g, h) {
                ...
                }, A = function(a) { return null == a || "" === a ? "&#160;" : d.p.autoencode ? $.jgrid.htmlEncode(a) : String(a); }, B = function(a, b, c, e, f) {
                    ...
                    return b && b.length || (b = $.map(d.p.colModel, function(a, b) { return b; })), a && (b = $.map(b, function(b) { return a > b ? null : b - a; })), b;
                }, H = function(a, b) {
                    var c;
                    ...
                    if (a) {
                        ...
                        if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (bb.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0)
                            try {
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        var p = { eq: function(a) { return a.equals; }, ne: function(a) { return a.notEquals; }, lt: function(a) { return a.less; }, le: function(a) { return a.lessOrEquals; }, gt: function(a) { return a.greater; }, ge: function(a) { return a.greaterOrEquals; }, cn: function(a) { return a.contains; }, nc: function(a, b) { return "OR" === b ? a.orNot().contains : a.andNot().contains; }, bw: function(a) { return a.startsWith; }, bn: function(a, b) { return "OR" === b ? a.orNot().startsWith : a.andNot().startsWith; }, en: function(a, b) { return "OR" === b ? a.orNot().endsWith : a.andNot().endsWith; }, ew: function(a) { return a.endsWith; }, ni: function(a, b) { return "OR" === b ? a.orNot().equals : a.andNot().equals; }, "in": function(a) { return a.equals; }, nu: function(a) { return a.isNull; }, nn: function(a, b) { return "OR" === b ? a.orNot().isNull : a.andNot().isNull; } }, q = $.jgrid.from.call(d, d.p.data);
                        ...
                        d.p.multiSort ? $.each(g, function(a) { q.orderBy(this, h[a], j[this].stype, j[this].srcfmt, j[this].sfunc); }) : g && d.p.sortorder && i && ("DESC" === d.p.sortorder.toUpperCase() ? q.orderBy(d.p.sortname, "d", j[g].stype, j[g].srcfmt, j[g].sfunc) : q.orderBy(d.p.sortname, "a", j[g].stype, j[g].srcfmt, j[g].sfunc));
                ...
                }, P = function() { d.grid.hDiv.loading = !0, d.p.hiddengrid || $(d).jqGrid("progressBar", { method: "show", loadtype: d.p.loadui, htmlcontent: $.jgrid.getRegional(d, "defaults.loadtext", d.p.loadtext) }); }, Q = function() { d.grid.hDiv.loading = !1, $(d).jqGrid("progressBar", { method: "hide", loadtype: d.p.loadui }); }, R = function(a) {
                    if (!d.grid.hDiv.loading) {
                        ...
                        if (a = a || 1, a > 1 ? null !== g.npage ? (f[g.npage] = a, j = a - 1, a = 1) : i = function(b) { d.p.page++, d.grid.hDiv.loading = !1, h && d.p.loadComplete.call(d, b), R(a - 1); } : null !== g.npage && delete d.p.postData[g.npage], d.p.grouping) {
                        ...
                        case "script":
                            $.ajax($.extend({
                                ...
                                success: function(c, f, g) { return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void Q() : ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && Q())); },
                                error: function(b, c, e) { $.isFunction(d.p.loadError) && d.p.loadError.call(d, b, c, e), 1 === a && Q(), b = null; },
                    ...
                    if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                        ...
                        d.p.subGrid && "local" === d.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(d.p.id)).each(function() { $(this).trigger("click"); }), d.p._sort = !0, R(), d.p.lastsort = b, d.p.sortname !== a && b && (d.p.lastsort = b);
                    }
                }, W = function() {
                ...
                if (d.p.disableClick = !1, $("th", sb).each(function(a) {
                    ...
                    if (1 === f.length) {
                        ...
                        if (d.p.frozenColumns) {
                            ...
                            $(d.p.colModel).each(function(a) { return this.name === h ? (g = a, !1) : void 0; });
                        } else g = Z(this);
        ...
        getDataIDs: function() {
            var a, b = [], c = 0, d = 0;
            return this.each(function() { if (a = this.rows.length, a && a > 0) for (; a > c;) $(this.rows[c]).hasClass("jqgrow") && (b[d] = this.rows[c].id, d++), c++; }), b;
        },
        ...
        resetSelection: function(a) {
            return this.each(function() {
                ...
                } else d.p.multiselect ? ($(d.p.selarrrow).each(function(a, b) { $($(d).jqGrid("getGridRowById", b)).removeClass(f).attr("aria-selected", "false"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", !1), c && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass(f), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c))[d.p.useProp ? "prop" : "attr"]("checked", !1)), d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, b); }), d.setHeadCheckBox(!1), d.p.selarrrow = [], d.p.selrow = null) : d.p.selrow && ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(d.p.selrow)).removeClass(f).attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(d.p.selrow), "#" + $.jgrid.jqID(c)).removeClass(f), d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, d.p.selrow), d.p.selrow = null);
        ...
        getRowData: function(a, b) {
            ...
            return this.each(function() {
                ...
                for (b && b === !0 && j.p.data.length > 0 || (b = !1); d > g;)
                    f && (i = j.rows[g]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function(a) {
        ...
        footerData: function(a, b, c) {
            ...
            return void 0 === a && (a = "get"), "boolean" != typeof c && (c = !0), a = a.toLowerCase(), this.each(function() {
                var i, j = this;
                return j.grid && j.p.footerrow ? "set" === a && d(b) ? !1 : (g = !0, void $(this.p.colModel).each(function(d) { e = this.name, "set" === a ? void 0 !== b[e] && (i = c ? j.formatter("", b[e], d, b, "edit") : b[e], f = this.title ? { title: $.jgrid.stripHtml(i) } : {}, $("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(i).attr(f), g = !0) : "get" === a && (h[e] = $("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html()); })) : !1;
            }), "get" === a ? h : g;
        },
                ...
                if (d.grid) {
                    ...
                    if (h && $(d).jqGrid("destroyGroupHeader", !1), $(this.p.colModel).each(function(h) {
                        if (-1 !== $.inArray(this.name, a) && this.hidden === g) {
                            ...
                            $("tr[role=row]", d.grid.hDiv).each(function() { $(this.cells[h]).css("display", b); }), $(d.rows).each(function() { $(this).hasClass("jqgroup") || $(this.cells[h]).css("display", b); }), d.p.footerrow && $("tr.footrow td:eq(" + h + ")", d.grid.sDiv).css("display", b), c = parseInt(this.width, 10), "none" === b ? d.p.tblwidth -= c + f : d.p.tblwidth += c + f, this.hidden = !g, e = !0, $(d).triggerHandler("jqGridShowHideCol", [g, this.name, h]);
                        }
        ...
        hideCol: function(a) { return this.each(function() { $(this).jqGrid("showHideCol", a, "none"); }); },
        showCol: function(a) { return this.each(function() { $(this).jqGrid("showHideCol", a, ""); }); },
        ...
        setLabel: function(a, b, c, d) {
            return this.each(function() {
                var e = this, f = -1;
                if (e.grid && void 0 !== a && ($(e.p.colModel).each(function(b) { return this.name === a ? (f = b, !1) : void 0; }), f >= 0)) {
        ...
        setCell: function(a, b, c, d, e, f) {
            return this.each(function() {
                var g, h, i = this, j = -1;
                if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function(a) { return this.name === b ? (j = a, !1) : void 0; }) : j = parseInt(b, 10), j >= 0)) {
        ...
        getCell: function(a, b) {
            ...
            return this.each(function() {
                var d = this, e = -1;
                if (d.grid && (isNaN(b) ? $(d.p.colModel).each(function(a) { return this.name === b ? (e = a, !1) : void 0; }) : e = parseInt(b, 10), e >= 0)) {
        ...
        getCol: function(a, b, c) {
            ...
            return b = "boolean" != typeof b ? !1 : b, void 0 === c && (c = !1), this.each(function() {
                var j = this, k = -1;
                if (j.grid && (isNaN(a) ? $(j.p.colModel).each(function(b) { return this.name === a ? (k = b, !1) : void 0; }) : k = parseInt(a, 10), k >= 0)) {
        ...
        getLocalRow: function(a) {
            var b, c = !1;
            return this.each(function() { void 0 !== a && (b = this.p._index[$.jgrid.stripPref(this.p.idPrefix, a)], b >= 0 && (c = this.p.data[b])); }), c;
        },
                    ...
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            ...
                            if (a.p.groupHeader) {
                                ...
                                var l, m, n = -1, o = -1;
                                $("tr.jqg-second-row-header th", k).each(function() { return l = parseInt($(this).attr("colspan"), 10), m = parseInt($(this).attr("rowspan"), 10), m && (n++, o++), l && (n += l, o++), n === e ? (o = e, !1) : void 0; }), n !== e && (o = e), $("tr.jqg-second-row-header", k).each(function() { $("th:gt(" + o + ")", this).remove(); });
                            } else $("tr", k).each(function() { $("th:gt(" + e + ")", this).remove(); });
                            if ($(k).width(1), $(a.grid.fhDiv).append(k).mousemove(function(b) { return a.grid.resizing ? (a.grid.dragMove(b), !1) : void 0; }), a.p.footerrow) {
                            ...
                            $(a).bind("jqGridResizeStop.setFrozenColumns", function(b, c, d) {
                                ...
                                $("tr[role=row]", b).each(function() { $("td[role=gridcell]:gt(" + e + ")", this).remove(); }), $(b).width(1).attr("id", a.p.id + "_frozen"), $(a.grid.fbDiv).append(b), a.p.hoverrows === !0 && ($("tr.jqgrow", b).hover(function() { $(this).addClass(h), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).addClass(h); }, function() { $(this).removeClass(h), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).removeClass(h); }), $("tr.jqgrow", "#" + $.jgrid.jqID(a.p.id)).hover(function() { $(this).addClass(h), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").addClass(h); }, function() { $(this).removeClass(h), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").removeClass(h); })), b = null;
            ...
            return this.each(function() {
                if (this.grid && this.p.frozenColumns === !0) {
                    ...
                    if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), $(this).unbind(".setFrozenColumns"), a.p.hoverrows === !0) {
                        var c;
                        $("#" + $.jgrid.jqID(a.p.id)).bind("mouseover", function(a) { c = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(c).attr("class") && $(c).addClass(b); }).bind("mouseout", function(a) { c = $(a.target).closest("tr.jqgrow"), $(c).removeClass(b); });
                    }
        ...
        editCell: function(a, b, c) {
            return this.each(function() {
                ...
                if (h.grid && h.p.cellEdit === !0) {
                    ...
                    } else window.setTimeout(function() { $("#" + $.jgrid.jqID(h.p.knv)).attr("tabindex", "-1").focus(); }, 1);
                    if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
                        if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b)) parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b);
                            ...
                            $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(o).addClass(k), $(f).html("").append(o).attr("tabindex", "0"), $.jgrid.bindEv.call(h, o, n), window.setTimeout(function() { $(o).focus(); }, 1), $("input, select, textarea", f).bind("keydown", function(c) {
                    ...
                    if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
                        ...
                        case "select":
                            if (j.editoptions.multiple) {
                                ...
                                g = $(m).val(), g ? g.join(",") : g = "", $("option:selected", m).each(function(a, b) { n[a] = $(b).text(); }), h = n.join(",");
                            ...
                            if (s[0] === !0) {
                                ...
                                if ($.isFunction(d.p.beforeSubmitCell) && (t = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), t || (t = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        ...
                                        var v, w, x;
                                        x = d.p.prmNames, v = x.id, w = x.oper, u[v] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), u[w] = x.editoper, u = $.extend(t, u), $(d).jqGrid("progressBar", { method: "show", loadtype: d.p.loadui, htmlcontent: $.jgrid.getRegional(d, "defaults.savetext") }), d.grid.hDiv.loading = !0, $.ajax($.extend({
                                            url: d.p.cellurl,
                                            ...
                                            error: function(c, g, h) { $("#lui_" + $.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = !1, $(d).triggerHandler("jqGridErrorCell", [c, g, h]), $.isFunction(d.p.errorCell) ? (d.p.errorCell.call(d, c, g, h), $(d).jqGrid("restoreCell", a, b)) : ($.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, { styleUI: d.p.styleUI }), $(d).jqGrid("restoreCell", a, b)); }
                                ...
                                try {
                                    window.setTimeout(function() { $.jgrid.info_dialog(e.errcap, g + " " + s[1], f.bClose, { styleUI: d.p.styleUI }); }, 100), $(d).jqGrid("restoreCell", a, b);
                                } catch(p) {
                                }
                        } else $(d).jqGrid("restoreCell", a, b);
                    }
                    window.setTimeout(function() { $("#" + $.jgrid.jqID(d.p.knv)).attr("tabindex", "-1").focus(); }, 0);
                }
            });
        },
        restoreCell: function(a, b) {
            return this.each(function() {
                ...
                if (d.grid && d.p.cellEdit === !0) {
                    ...
                    window.setTimeout(function() { $("#" + d.p.knv).attr("tabindex", "-1").focus(); }, 0);
                }
            });
        },
        ...
        createModal: function(a, b, c, d, e, f, g) {
            ...
            var n = $("<a class='ui-jqdialog-titlebar-close " + k.cornerall + "'></a>").hover(function() { n.addClass(k.hover); }, function() { n.removeClass(k.hover); }).append("<span class='" + k.icon_base + " " + j.icon_close + "'></span>");
            ...
            var s = 0;
            if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({ width: isNaN(c.width) ? "auto" : c.width + "px", height: isNaN(c.height) ? "auto" : c.height + "px", zIndex: c.zIndex, overflow: "hidden" }, p)).attr({ tabIndex: "-1", role: "dialog", "aria-labelledby": a.modalhead, "aria-hidden": "true" }), void 0 === c.drag && (c.drag = !0), void 0 === c.resize && (c.resize = !0), c.drag)
        ...
        bindEv: function(a, b) {
            var c = this;
            $.isFunction(b.dataInit) && b.dataInit.call(c, a, b), b.dataEvents && $.each(b.dataEvents, function() { void 0 !== this.data ? $(a).bind(this.type, this.data, this.fn) : $(a).bind(this.type, this.fn); });
        },
        createEl: function(a, b, c, d, e) {
            ...
            function f(a, b, c) {
                ...
                void 0 !== c && $.isArray(c) && $.merge(d, c), $.each(b, function(b, c) { -1 === $.inArray(b, d) && $(a).attr(b, c); }), b.hasOwnProperty("id") || $(a).attr("id", $.jgrid.randId());
            }
                ...
                if (b.multiple === !0 ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
                    ...
                    h.p && h.p.idPrefix && (m = $.jgrid.stripPref(h.p.idPrefix, m)), $.ajax($.extend({
                        ...
                        success: function(a) {
                            ...
                            "string" == typeof l && (l = $($.trim(l)).html()), l && ($(d).append(l), f(d, g, n ? ["postData"] : void 0), void 0 === g.size && (g.size = i ? 3 : 1), i ? (c = e.split(","), c = $.map(c, function(a) { return $.trim(a); })) : c[0] = $.trim(e), setTimeout(function() {
                                if ($("option", d).each(function(a) { b = $(this).text(), e = $(this).val() || b, j && (k += (0 !== a ? ";" : "") + e + ":" + b), 0 === a && d.multiple && (this.selected = !1), $(this).attr("role", "option"), ($.inArray($.trim(b), c) > -1 || $.inArray($.trim(e), c) > -1) && (this.selected = "selected"); }), j)
                                    if ("edit" === g.oper) $(h).jqGrid("setColProp", g.name, { editoptions: { buildSelect: null, dataUrl: null, value: k } });
                                        ...
                                        $.each(f, function() { return a = this.index || this.name, g.name === a ? (this.searchoptions.dataUrl = null, this.searchoptions.value = k, !1) : void 0; });
                                    }
                    ...
                    var p;
                    void 0 === b.size && (b.size = k ? 3 : 1), k && (l = c.split(","), l = $.map(l, function(a) { return $.trim(a); })), "function" == typeof b.value && (b.value = b.value());
                    ...
                    if ("string" == typeof b.value)
                        for (q = b.value.split(x), p = 0; p < q.length; p++)
                            r = q[p].split(w), r.length > 2 && (r[1] = $.map(r, function(a, b) {
                                return b > 0 ? a : void 0;
        ...
        checkDate: function(a, b) {
            var c, d = function(a) { return a % 4 !== 0 || a % 100 === 0 && a % 400 !== 0 ? 28 : 29; }, e = {};
        ...
        var d = $.extend(!0, { filter: null, columns: [], sortStrategy: null, onChange: null, afterRedraw: null, checkValues: null, error: !1, errmsg: "", errorcheck: !0, showQuery: !0, sopt: null, ops: [], operands: null, numopts: ["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"], stropts: ["eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"], strarr: ["text", "string", "blob"], groupOps: [{ op: "AND", text: "AND" }, { op: "OR", text: "OR" }], groupButton: !0, ruleButtons: !0, direction: "ltr" }, $.jgrid.filter, a || {});
        return this.each(function() {
            if (!this.filter) {
                ...
                if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
                    ...
                    var f = function() { return $("#" + $.jgrid.jqID(d.id))[0] || null; }, g = f(), h = $.jgrid.styleUI[g.p.styleUI || "jQueryUI"].filter, i = $.jgrid.styleUI[g.p.styleUI || "jQueryUI"].common;
                    ...
                    this.onchange = function() { return this.p.error = !1, this.p.errmsg = "", $.isFunction(this.p.onChange) ? this.p.onChange.call(this, this.p) : !1; }, this.reDraw = function() {
                        ...
                        if (j.append(k), this.p.ruleButtons === !0) {
                            ...
                            l.append(n).bind("change", function() { a.groupOp = $(l).val(), e.onchange(); });
                        }
                        var o = "<span></span>";
                        if (this.p.groupButton && (o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + i.button + "'/>"), o.bind("click", function() { return void 0 === a.groups && (a.groups = []), a.groups.push({ groupOp: d.groupOps[0].op, rules: [], groups: [] }), e.reDraw(), e.onchange(), !1; })), k.append(o), this.p.ruleButtons === !0) {
                        ...
                        q.append(s), s.bind("change", function() {
                            ...
                            if (k) {
                                ...
                                var d = "", f = 0;
                                for (t = [], $.each(m.p.ops, function() { t.push(this.oper); }), c = 0; c < g.length; c++) r = $.inArray(g[c], t), -1 !== r && (0 === f && (a.op = m.p.ops[r].oper), d += "<option value='" + m.p.ops[r].oper + "'>" + m.p.ops[r].text + "</option>", f++);
                                ...
                                }), setTimeout(function() { a.data = $(b).val(), m.onchange(); }, 0);
                            }
                        });
                        var u = 0;
                        ...
                        }), g = k.searchoptions.sopt ? k.searchoptions.sopt : m.p.sopt ? m.p.sopt : -1 !== $.inArray(k.searchtype, m.p.strarr) ? m.p.stropts : m.p.numopts, p = "", $.each(m.p.ops, function() { t.push(this.oper); }), c = 0; c < g.length; c++) r = $.inArray(g[c], t), -1 !== r && (l = a.op === m.p.ops[r].oper ? " selected='selected'" : "", p += "<option value='" + m.p.ops[r].oper + "'" + l + ">" + m.p.ops[r].text + "</option>");
                        A.append(p);
                        var B = $("<td class='data'></td>");
                        o.append(B), B.append(z), $.jgrid.bindEv.call(n, z, k.searchoptions), $(z).addClass("input-elm " + h.srInput).bind("change", function() { a.data = "custom" === k.inputtype ? k.searchoptions.custom_value.call(n, $(this).children(".customelement:first"), "get") : $(this).val(), m.onchange(); });
                        var C = $("<td></td>");
        ...
        getParameter: function(a) { return void 0 !== a && this.p.hasOwnProperty(a) ? this.p[a] : this.p; },
        resetFilter: function() { return this.each(function() { this.resetFilter(); }); },
        addFilter: function(a) { "string" == typeof a && (a = $.jgrid.parse(a)), this.each(function() { this.p.filter = a, this.reDraw(), this.onchange(); }); }
    }), $.jgrid.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, f = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, h = function() {
                        ...
                        if (a.stringResult === !0 || "local" === c.p.datatype || a.searchOperators === !0) {
                            ...
                            $.each(f, function(a, b) { k > 0 && (j += ","), j += '{"field":"' + a + '",', j += '"op":"' + h[a] + '",', b += "", j += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', k++; }), j += "]}", $.extend(c.p.postData, { filters: j }), $.each(["searchField", "searchString", "searchOper"], function(a, b) { c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]; });
                        ...
                        b = "boolean" != typeof b ? !0 : b, $.each(c.p.colModel, function() {
                            ...
                            case "select":
                                if (b.find("option").each(function(b) { return 0 === b && (this.selected = !0), $(this).val() === a ? (this.selected = !0, !1) : void 0; }), void 0 !== a) e[d] = a, f++;
                                else
                                    try {
                                        delete c.p.postData[d];
                                    } catch(g) {
                        ...
                        if (c.p.resetsearch = !0, a.stringResult === !0 || "local" === c.p.datatype) {
                            ...
                            $.each(e, function(a, b) { i > 0 && (h += ","), h += '{"field":"' + a + '",', h += '"op":"eq",', b += "", h += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', i++; }), h += "]}", $.extend(c.p.postData, { filters: h }), $.each(["searchField", "searchString", "searchOper"], function(a, b) { c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]; });
                        ...
                        for (s.sopt || (s.sopt = [], s.sopt[0] = "select" === r.stype ? "eq" : a.defaultSearch), $.each(a.odata, function() { n.push(this.oper); }), o = 0; o < s.sopt.length; o++) j = $.inArray(s.sopt[o], n), -1 !== j && (i = m === a.odata[j].oper ? f.highlight : "", l += '<li class="ui-menu-item ' + i + '" role="presentation"><a class="' + f.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[j].oper + '" oper="' + a.operands[a.odata[j].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + a.operands[a.odata[j].oper] + "</td><td>" + a.odata[j].text + "</td></tr></table></a></li>");
                        l += "</ul>", $("body").append(l), $("#sopt_menu").addClass("ui-menu " + e.menu_widget), $("#sopt_menu > li > a").hover(function() { $(this).addClass(f.hover); }, function() { $(this).removeClass(f.hover); }).click(function() {
                    ...
                    $.each(c.p.colModel, function(b) {
                        ...
                        if (this.hidden === !0 && $(s).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), f = $.extend({}, this.searchoptions || {}, { name: p.index || p.name, id: "gs_" + c.p.idPrefix + p.name, oper: "search" }), this.search) {
                            ...
                            case "select":
                                a.autosearch === !0 && (f.dataEvents = [{ type: "change", fn: function() { return h(), !1; } }]);
                                break;
                            case "text":
                                a.autosearch === !0 && (f.dataEvents = a.searchOnEnter ? [{
                                        ...
                                        fn: function(b) {
                                            ...
                                            case 27:
                                                break;
                                            default:
                                                d && clearTimeout(d), d = setTimeout(function() { h(); }, a.autosearchDelay);
                                            }
                                        }
                                    }]);
                            }
                    ...
                    }), $("body").on("click", function(a) { "soptclass" !== a.target.className && $("#sopt_menu").hide(); })), $(".clearsearchclass", l).click(function() {
        ...
        destroyFilterToolbar: function() { return this.each(function() { this.p.filterToolbar && (this.triggerToolbar = null, this.clearToolbar = null, this.toggleToolbar = null, this.p.filterToolbar = !1, $(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove()); }); },
            ...
            return a = $.extend(!0, { recreateFilter: !1, drag: !0, sField: "searchField", sValue: "searchString", sOper: "searchOper", sFilter: "filters", loadDefaults: !0, beforeShowSearch: null, afterShowSearch: null, onInitializeSearch: null, afterRedraw: null, afterChange: null, sortStrategy: null, closeAfterSearch: !1, closeAfterReset: !1, closeOnEscape: !1, searchOnEnter: !1, multipleSearch: !1, multipleGroup: !1, top: 0, left: 0, jqModal: !0, modal: !1, resize: !0, width: 450, height: "auto", dataheight: "auto", showQuery: !1, errorcheck: !0, sopt: null, stringResult: void 0, onClose: null, onSearch: null, onReset: null, toTop: !0, overlay: 30, columns: [], tmplNames: null, tmplFilters: null, tmplLabel: " Template: ", showOnLoad: !1, layer: null, operands: { eq: "=", ne: "<>", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "LIKE", bn: "NOT LIKE", "in": "IN", ni: "NOT IN", ew: "LIKE", en: "NOT LIKE", cn: "LIKE", nc: "NOT LIKE", nu: "IS NULL", nn: "ISNOT NULL" } }, b, a || {}), this.each(function() {
                ...
                if (c.grid) {
                    ...
                    if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));
                        ...
                        v = !1, a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function(a, b) { u += "<option value='" + a + "'>" + b + "</option>"; }), u += "</select></td></tr>"), p = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='" + k.content + "' style='margin:1px'/></td></tr>" + u + "<tr><td class='EditButton' style='text-align:" + m + "'>" + s + "</td><td class='EditButton' " + n + ">" + t + r + "</td></tr></tbody></table>", e = $.jgrid.jqID(e), $("#" + e).jqFilter({ columns: q, sortStrategy: a.sortStrategy, filter: a.loadDefaults ? i : null, showQuery: a.showQuery, errorcheck: a.errorcheck, sopt: a.sopt, groupButton: a.multipleGroup, ruleButtons: a.multipleSearch, afterRedraw: a.afterRedraw, ops: a.odata, operands: a.operands, ajaxSelectOptions: c.p.ajaxSelectOptions, groupOps: a.groupOps, onChange: function() { this.p.showQuery && $(".query", this).html(this.toUserFriendlyString()), $.isFunction(a.afterChange) && a.afterChange.call(c, $("#" + e), a); }, direction: c.p.direction, id: c.p.id }), l.append(p), v && a.tmplFilters && a.tmplFilters.length && $(".ui-template", l).bind("change", function() {
                        ...
                        }), t && $("#" + e + "_query").bind("click", function() { return $(".queryresult", l).toggle(), !1; }), void 0 === a.stringResult && (a.stringResult = a.multipleSearch), $("#" + e + "_search").bind("click", function() {
                            var b, f, i = {};
                            ...
                            if (a.stringResult) {
                                ...
                                "string" == typeof b && (i[a.sFilter] = b, $.each([a.sField, a.sValue, a.sOper], function() { i[this] = ""; }));
                            } else
                            ...
                            return c.p.search = !0, $.extend(c.p.postData, i), g = $(c).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && $.isFunction(a.onSearch) && (g = a.onSearch.call(c, c.p.filters)), g !== !1 && $(c).trigger("reloadGrid", [{ page: 1 }]), a.closeAfterSearch && $.jgrid.hideModal("#" + $.jgrid.jqID(h.themodal), { gb: "#gbox_" + $.jgrid.jqID(c.p.id), jqm: a.jqModal, onClose: a.onClose }), !1;
                        }), $("#" + e + "_reset").bind("click", function() {
                            var b = {}, d = $("#" + e);
                            return c.p.search = !1, c.p.resetsearch = !0, a.multipleSearch === !1 ? b[a.sField] = b[a.sValue] = b[a.sOper] = "" : b[a.sFilter] = "", d[0].resetFilter(), v && $(".ui-template", l).val("default"), $.extend(c.p.postData, b), g = $(c).triggerHandler("jqGridFilterReset"), void 0 === g && (g = !0), g && $.isFunction(a.onReset) && (g = a.onReset.call(c)), g !== !1 && $(c).trigger("reloadGrid", [{ page: 1 }]), a.closeAfterReset && $.jgrid.hideModal("#" + $.jgrid.jqID(h.themodal), { gb: "#gbox_" + $.jgrid.jqID(c.p.id), jqm: a.jqModal, onClose: a.onClose }), !1;
                        }), b($("#" + e)), $(".fm-button:not(." + k.disabled + ")", l).hover(function() { $(this).addClass(k.hover); }, function() { $(this).removeClass(k.hover); });
                    }
                }
            });
        }
    ...
    if ($.jgrid.extend({
            editGridRow: function(a, b) {
                ...
                return b = $.extend(!0, { top: 0, left: 0, width: "500", datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: null, mtype: "POST", clearAfterAdd: !0, closeAfterEdit: !1, reloadAfterSubmit: !0, onInitializeForm: null, beforeInitData: null, beforeShowForm: null, afterShowForm: null, beforeSubmit: null, afterSubmit: null, onclickSubmit: null, afterComplete: null, onclickPgButtons: null, afterclickPgButtons: null, editData: {}, recreateForm: !1, jqModal: !0, closeOnEscape: !1, addedrow: "first", topinfo: "", bottominfo: "", saveicon: [], closeicon: [], savekey: [!1, 13], navkeys: [!1, 38, 40], checkOnSubmit: !1, checkOnUpdate: !1, _savedData: {}, processing: !1, onClose: null, ajaxEditOptions: {}, serializeEditData: null, viewPagerButtons: !0, overlayClass: f.overlay, removemodal: !0, form: "edit", template: null, focusField: !0 }, c, b || {}), rp_ge[$(this)[0].p.id] = b, this.each(function() {
                        ...
                        return $(x).find(".FormElement").each(function() {
                            ...
                            if (a.length) {
                                ...
                                case "select-multiple":
                                    ...
                                    var e = [];
                                    $("option:selected", this).each(function(a, b) { e[a] = $(b).text(); });
                                    break;
                                case "password":
                                case "text":
                                case "textarea":
                    ...
                    function g(a, b, c) {
                        ...
                        var k = b.p.colModel;
                        if ("_empty" === a) return $(k).each(function() { d = this.name, g = $.extend({}, this.editoptions || {}), f = $("#" + $.jgrid.jqID(d), c), f && f.length && null !== f[0] && (h = "", "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(p, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(p) : g.defaultValue, "checkbox" === f[0].type ? (i = h.toLowerCase(), i.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== i ? (f[0].checked = !0, f[0].defaultChecked = !0, f[0].value = h) : (f[0].checked = !1, f[0].defaultChecked = !1)) : f.val(h)) : "checkbox" === f[0].type ? (f[0].checked = !1, f[0].defaultChecked = !1, h = $(f).attr("offval")) : f[0].type && "select" === f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(h), (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = h)); }), void $("#id_g", c).val(a);
                        ...
                        l && ($('td[role="gridcell"]', l).each(function(f) {
                            if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                                ...
                                case "select":
                                    var h = e.split(",");
                                    h = $.map(h, function(a) { return $.trim(a); }), $("#" + d + " option", c).each(function() { this.selected = k[f].editoptions.multiple || $.trim(e) !== $.trim($(this).text()) && h[0] !== $.trim($(this).text()) && h[0] !== $.trim($(this).val()) ? k[f].editoptions.multiple && ($.inArray($.trim($(this).text()), h) > -1 || $.inArray($.trim($(this).val()), h) > -1) ? !0 : !1 : !0; }), (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (e = $("#" + d, c).val(), k[f].editoptions.multiple && (e = e.join(",")), rp_ge[p.p.id]._savedData[d] = e);
                                    break;
                                case "checkbox":
                    ...
                    function h() { $.each(p.p.colModel, function(a, b) { b.editoptions && b.editoptions.NullIfEmpty === !0 && r.hasOwnProperty(b.name) && "" === r[b.name] && (r[b.name] = "null"); }); }
                    ...
                    function o(a) {
                        var b = "";
                        return "string" == typeof a && (b = a.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function(a, b) { return '<span id="' + b + '" ></span>'; })), b;
                    }
                    ...
                    if (p.grid && a) {
                        ...
                        if (C ? (F = o(rp_ge[$(this)[0].p.id].template), q = x) : (F = $("<table id='" + w + "' class='EditTable ui-common-table'><tbody></tbody></table>"), q = x + "_2"), v = "#" + $.jgrid.jqID(v), $(I).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(I).append("<div class='tinfo topinfo'>" + rp_ge[p.p.id].topinfo + "</div>"), $(p.p.colModel).each(function() {
                            ...
                            if (Q += "</tbody></table>", B > 0) {
                                var R = [];
                                $.each($(F)[0].rows, function(a, b) { R[a] = b; }), R.sort(function(a, b) { return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0; }), $.each(R, function(a, b) { $("tbody", F).append(b); });
                            }
            ...
            viewGridRow: function(a, b) {
                ...
                return b = $.extend(!0, { top: 0, left: 0, width: 500, datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, jqModal: !0, closeOnEscape: !1, labelswidth: "30%", closeicon: [], navkeys: [!1, 38, 40], onClose: null, beforeShowForm: null, beforeInitData: null, viewPagerButtons: !0, recreateForm: !1, removemodal: !0, form: "view" }, c, b || {}), rp_ge[$(this)[0].p.id] = b, this.each(function() {
                    ...
                    function c() { (rp_ge[j.p.id].closeOnEscape === !0 || rp_ge[j.p.id].navkeys[0] === !0) && setTimeout(function() { $(".ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(p.modalhead)).attr("tabindex", "-1").focus(); }, 0); }
                    ...
                    function d(a, c, d, e) {
                        ...
                        if ($(c.p.colModel).each(function() { h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, h || "right" !== this.align || (this.formatter && -1 !== $.inArray(this.formatter, v) ? w = Math.max(w, parseInt(this.width, 10)) : x = Math.max(x, parseInt(this.width, 10))); }), m = 0 !== w ? w : 0 !== x ? x : 0, r = $(c).jqGrid("getInd", a), $(c.p.colModel).each(function(a) {
                    ...
                    function g(a, b) {
                        var c, d, e, f, g = 0;
                        f = $(b).jqGrid("getInd", a, !0), f && ($("td", f).each(function(a) { c = b.p.colModel[a].name, d = b.p.colModel[a].editrules && b.p.colModel[a].editrules.edithidden === !0 ? !1 : b.p.colModel[a].hidden === !0 ? !0 : !1, "cb" !== c && "subgrid" !== c && "rn" !== c && (e = c === b.p.ExpandColumn && b.p.treeGrid === !0 ? $(this).text() : $(this).html(), c = $.jgrid.jqID("v_" + c), $("#" + c + " span", "#" + m).html(e), d && $("#" + c, "#" + m).parents("tr:first").hide(), g++); }), g > 0 && $("#id_g", "#" + m).val(a));
                    }
                    ...
                    if (j.grid && a) {
                        ...
                        if ($(j.p.colModel).each(function() {
                            ...
                            if (t > 0) {
                                var E = [];
                                $.each($(x)[0].rows, function(a, b) { E[a] = b; }), E.sort(function(a, b) { return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0; }), $.each(E, function(a, b) { $("tbody", x).append(b); });
                            }
                ...
                return b = $.extend(!0, { top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: "", mtype: "POST", reloadAfterSubmit: !0, beforeShowForm: null, beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: !0, closeOnEscape: !1, delData: {}, delicon: [], cancelicon: [], onClose: null, ajaxDelOptions: {}, processing: !1, serializeDelData: null, useDataProxy: !1 }, c, b || {}), rp_ge[$(this)[0].p.id] = b, this.each(function() {
                    ...
                    if (c.grid && a) {
                        ...
                        if (rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI", $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(r.themodal))[0]) {
                                    ...
                                    var k = $.extend({
                                        ...
                                        complete: function(a, g) {
                                            ...
                                            if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, e[1] = $.isFunction(rp_ge[c.p.id].errorTextFormat) ? rp_ge[c.p.id].errorTextFormat.call(c, a) : g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1) $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show();
                                                ...
                                                $.isFunction(rp_ge[c.p.id].afterComplete) && setTimeout(function() { rp_ge[c.p.id].afterComplete.call(c, a, j); }, 500);
                                            }
                            ...
                            }), $("#eData", "#" + p + "_2").click(function() { return $.jgrid.hideModal("#" + $.jgrid.jqID(r.themodal), { gb: "#gbox_" + $.jgrid.jqID(m), jqm: rp_ge[c.p.id].jqModal, onClose: rp_ge[c.p.id].onClose }), !1; }), j && rp_ge[c.p.id].beforeShowForm.call(c, $("#" + p)), $.jgrid.viewModal("#" + $.jgrid.jqID(r.themodal), { gbox: "#gbox_" + $.jgrid.jqID(m), jqm: rp_ge[c.p.id].jqModal, overlay: rp_ge[c.p.id].overlay, modal: rp_ge[c.p.id].modal }), k && rp_ge[c.p.id].afterShowForm.call(c, $("#" + p));
                        }
                        rp_ge[c.p.id].closeOnEscape === !0 && setTimeout(function() { $(".ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(r.modalhead)).attr("tabindex", "-1").focus(); }, 0);
                    }
                });
            },
                ...
                return b = $.extend({ edit: !0, editicon: j.icon_edit_nav, add: !0, addicon: j.icon_add_nav, del: !0, delicon: j.icon_del_nav, search: !0, searchicon: j.icon_search_nav, refresh: !0, refreshicon: j.icon_refresh_nav, refreshstate: "firstpage", view: !1, viewicon: j.icon_view_nav, position: "left", closeOnEscape: !0, beforeRefresh: null, afterRefresh: null, cloneToTop: !1, alertwidth: 200, alertheight: "auto", alerttop: null, alertleft: null, alertzIndex: null, dropmenu: !1 }, h, b || {}), this.each(function() {
                    if (!this.p.navGrid) {
                        ...
                        if (o.grid && "string" == typeof a) {
                            ...
                            var p, q = 1, r = function() { $(this).hasClass(k.disabled) || $(this).addClass(k.hover); }, s = function() { $(this).removeClass(k.hover); };
                ...
                return b = $.extend({ caption: "newButton", title: "", buttonicon: d.icon_newbutton_nav, onClickButton: null, position: "last", cursor: "pointer" }, b || {}), this.each(function() {
                    if (this.grid) {
                        ...
                        if (d) {
                            ...
                            k && ("first" === b.position ? $("#" + k).prepend(m) : $("#" + k).append(m), $(m).on("click", function(a) { return $(this).hasClass(f) || ($("#" + k).hide(), $.isFunction(b.onClickButton) && b.onClickButton.call(e, a)), !1; }).find("a").hover(function() { $(this).hasClass(f) || $(this).addClass(g); }, function() { $(this).removeClass(g); }));
                        }
                    }
                });
            },
                ...
                return this.each(function() {
                    ...
                    var o = { themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id }, p = function() {
                        ...
                        c.add && (e = e || {}, a = e.id || "add_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function() { return $(this).hasClass(l.disabled) || ($.isFunction(c.addfunc) ? c.addfunc.call(i) : $(i).jqGrid("editGridRow", "new", e), $(p).hide()), !1; }), $(p).append(j)), c.edit && (d = d || {}, a = d.id || "edit_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.edittext || c.edittitle) + "</a></li>").click(function() {
                            ...
                            return !1;
                        }), $(p).append(j)), $(p).hide(), $("body").append(p), $("#" + m).addClass("ui-menu " + k.menu_widget), $("#" + m + " > li > a").hover(function() { $(this).addClass(l.hover); }, function() { $(this).removeClass(l.hover); });
                    };
                    ...
                    }), $("body").on("click", function(a) { $(a.target).hasClass("dropdownmenu") || $("#" + m).hide(); });
                });
            },
            GridToForm: function(a, b) {
                return this.each(function() {
                    ...
                    if (d.grid) {
                        ...
                        if (e) for (c in e) e.hasOwnProperty(c) && ($("[name=" + $.jgrid.jqID(c) + "]", b).is("input:radio") || $("[name=" + $.jgrid.jqID(c) + "]", b).is("input:checkbox") ? $("[name=" + $.jgrid.jqID(c) + "]", b).each(function() { $(this).val() == e[c] ? $(this)[d.p.useProp ? "prop" : "attr"]("checked", !0) : $(this)[d.p.useProp ? "prop" : "attr"]("checked", !1); }) : $("[name=" + $.jgrid.jqID(c) + "]", b).val(e[c]));
                    }
                });
            },
            FormToGrid: function(a, b, c, d) {
                return this.each(function() {
                    ...
                    if (e.grid) {
                        ...
                        $.each(f, function(a, b) { g[b.name] = b.value; }), "add" === c ? $(e).jqGrid("addRowData", a, g, d) : "set" === c && $(e).jqGrid("setRowData", a, g);
                    }
                });
            }
        }), $.jgrid.extend({
            ...
            groupingToggle: function(a) {
                return this.each(function() {
                    ...
                    var f, g, h = d.join("_"), i = c.minusicon, j = c.plusicon, k = $("#" + $.jgrid.jqID(a)), l = k.length ? k[0].nextSibling : null, m = $("#" + $.jgrid.jqID(a) + " span.tree-wrap-" + b.p.direction), n = function(a) {
                        var b = $.map(a.split(" "), function(a) { return a.substring(0, h.length + 1) === h + "_" ? parseInt(a.substring(h.length + 1), 10) : void 0; });
            ...
            groupingCalculations: {
                handler: function(a, b, c, d, e, f) {
                    var g = { sum: function() { return parseFloat(b || 0) + parseFloat(f[c] || 0); }, min: function() { return "" === b ? parseFloat(f[c] || 0) : Math.min(parseFloat(b), parseFloat(f[c] || 0)); }, max: function() { return "" === b ? parseFloat(f[c] || 0) : Math.max(parseFloat(b), parseFloat(f[c] || 0)); }, count: function() { return "" === b && (b = 0), f.hasOwnProperty(c) ? b + 1 : 0; }, avg: function() { return g.sum(); } };
            ...
            setGroupHeaders: function(a) {
                return a = $.extend({ useColSpanStyle: !1, groupHeaders: [] }, a || {}), this.each(function() {
                    ...
                    for ($(p).prepend(w), d = $("<tr>", { role: "row" }).addClass("ui-jqgrid-labels jqg-third-row-header"), b = 0; s > b; b++)
                        if (f = t[b].el, g = $(f), c = r[b], h = { height: "0px", width: t[b].width + "px", display: c.hidden ? "none" : "" }, $("<th>", { role: "gridcell" }).css(h).addClass("ui-first-th-" + p.p.direction).appendTo(x), f.style.width = "", i = A(c.name, a.groupHeaders), i >= 0) {
                    ...
                    })), z = o.find("tr.jqg-first-row-header"), $(p).bind("jqGridResizeStop.setGroupHeaders", function(a, b, c) { z.find("th").eq(c).width(b); });
                });
            },
            ...
            saveState: function(a, b) {
                if (b = $.extend({ useStorage: !0, storageType: "localStorage", beforeSetItem: null, compression: !1, compressionModule: "LZString", compressionMethod: "compressToUTF16" }, b || {}), a) {
                    var c, d, e = "", f = "", g = $("#" + a)[0];
                    if (g.grid) {
                        if (d = $(g).data("inlineNav"), d && g.p.inlineNav && $(g).jqGrid("setGridParam", { _iN: d }), d = $(g).data("filterToolbar"), d && g.p.filterToolbar && $(g).jqGrid("setGridParam", { _fT: d }), e = $(g).jqGrid("jqGridExport", { exptype: "jsonstring", ident: "", root: "" }), $(g.grid.bDiv).find(".ui-jqgrid-btable tr:gt(0)").each(function(a, b) { f += b.outerHTML; }), $.isFunction(b.beforeSetItem) && (c = b.beforeSetItem.call(g, e), null != c && (e = c)), b.compression && b.compressionModule)
                            try {
            ...
            loadState: function(a, b, c) {
                if (c = $.extend({ useStorage: !0, storageType: "localStorage", clearAfterLoad: !1, beforeSetGrid: null, decompression: !1, decompressionModule: "LZString", decompressionMethod: "decompressFromUTF16" }, c || {}), a) {
                    var d, e, f, g, h, i = $("#" + a)[0];
                    if (i.grid && $.jgrid.gridUnload(a), c.useStorage)
                        try {
            ...
            setRegional: function(a, b) {
                $.jgrid.saveState(a, { storageType: "sessionStorage" }), $.jgrid.loadState(a, null, { storageType: "sessionStorage", beforeSetGrid: function(a) { return a.regional = b.regional, a.force_regional = !0, a; } });
                var c = $("#" + a)[0], d = $(c).jqGrid("getGridParam", "colModel"), e = -1, f = $.jgrid.getRegional(c, "nav");
                $.each(d, function(a) { return this.formatter && "actions" === this.formatter ? (e = a, !1) : void 0; }), -1 !== e && f && $("#" + a + " tbody tr").each(function() {
                    var a = this.cells[e];
            ...
            jqGridImport: function(a, b) {
                ...
                var c = (0 === a.indexOf("#") ? "" : "#") + $.jgrid.jqID(a), d = function(a, b) {
                    ...
                    if (jqGridUtils.xmlToJSON) {
                        ...
                        } else setTimeout(function() { $(c).jqGrid(e); }, 0);
                ...
                switch (b.imptype) {
                case "xml":
                    $.ajax($.extend({ url: b.impurl, type: b.mtype, data: b.impData, dataType: "xml", complete: function(a, e) { "success" === e && (d(a.responseXML, b), $(c).triggerHandler("jqGridImportComplete", [a, b]), $.isFunction(b.importComplete) && b.importComplete(a)), a = null; } }, b.ajaxOptions));
                    break;
                case "xmlstring":
                ...
                if (void 0 === x && (x = !0), x) {
                    if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
                            ...
                            if (y = j.p.colModel[a], k = y.name, "cb" !== k && "subgrid" !== k && y.editable === !0 && "rn" !== k && !$(this).hasClass("not-editable-cell")) {
                                ...
                                case "select":
                                    if (y.editoptions.multiple) {
                                        var c = $("select", this), d = [];
                                        q[k] = $(c).val(), q[k] = q[k] ? q[k].join(",") : "", $("select option:selected", this).each(function(a, b) { d[a] = $(b).text(); }), r[k] = d.join(",");
                        ...
                        if ("clientArray" === i.url) {
                            q = $.extend({}, q, r), j.p.autoencode && $.each(q, function(a, b) { q[a] = $.jgrid.htmlDecode(b); });
                            ...
                            $(j).jqGrid("progressBar", { method: "show", loadtype: i.saveui, htmlcontent: i.savetext }), s = $.extend({}, q, s), s[C] = $.jgrid.stripPref(j.p.idPrefix, s[C]), $.ajax($.extend({
                                url: i.url,
                                ...
                                complete: function(b, c) {
                                    if ($(j).jqGrid("progressBar", { method: "hide", loadtype: i.saveui, htmlcontent: i.savetext }), "success" === c) {
                                        ...
                                        if (d = $(j).triggerHandler("jqGridInlineSuccessSaveRow", [b, a, i]), $.isArray(d) || (d = [!0, s]), d[0] && $.isFunction(i.successfunc) && (d = i.successfunc.call(j, b)), $.isArray(d) ? (f = d[0], q = d[1] || q) : f = d, f === !0) {
                                            for (j.p.autoencode && $.each(q, function(a, b) { q[a] = $.jgrid.htmlDecode(b); }), t && $.each(q, function(a) { "null" === q[a] && (q[a] = ""); }), q = $.extend({}, q, r), $(j).jqGrid("setRowData", a, q), $(o).attr("editable", "0"), e = 0; e < j.p.savedRow.length; e++)
                    ...
                    if (e.grid && (b = $(e).jqGrid("getInd", a, !0), b !== !1)) {
                        ...
                        if (void 0 === h && (h = !0), h) {
                            ...
                            if (f >= 0) {
                                ...
                                $.each(e.p.colModel, function() { this.editable === !0 && e.p.savedRow[f].hasOwnProperty(this.name) && (g[this.name] = e.p.savedRow[f][this.name]); }), $(e).jqGrid("setRowData", a, g), $(b).attr("editable", "0").unbind("keydown"), e.p.savedRow.splice(f, 1), $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(e.p.id)).hasClass("jqgrid-new-row") && setTimeout(function() { $(e).jqGrid("delRowData", a), $(e).jqGrid("showAddEditButtons"); }, 0);
                            }
            ...
            inlineNav: function(a, b) {
                ...
                return b = $.extend(!0, { edit: !0, editicon: e.icon_edit_nav, add: !0, addicon: e.icon_add_nav, save: !0, saveicon: e.icon_save_nav, cancel: !0, cancelicon: e.icon_cancel_nav, addParams: { addRowParams: { extraparam: {} } }, editParams: {}, restoreAfterSelect: !0 }, d, b || {}), this.each(function() {
                    if (this.grid && !this.p.inlineNav) {
                        ...
                        b.add && $(c).jqGrid("navButtonAdd", a, { caption: b.addtext, title: b.addtitle, buttonicon: b.addicon, id: c.p.id + "_iladd", onClickButton: function() { $(c).jqGrid("addRow", b.addParams), b.addParams.useFormatter || ($("#" + e + "_ilsave").removeClass(f), $("#" + e + "_ilcancel").removeClass(f), $("#" + e + "_iladd").addClass(f), $("#" + e + "_iledit").addClass(f)); } }), b.edit && $(c).jqGrid("navButtonAdd", a, {
                            caption: b.edittext,
                            title: b.edittitle,
                        ...
                        }), $("#" + e + "_ilcancel").addClass(f)), b.restoreAfterSelect === !0 && $(c).bind("jqGridBeforeSelectRow.inlineNav", function(a, d) { c.p.savedRow.length > 0 && c.p.inlineNav === !0 && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : $(c).jqGrid("restoreRow", c.p.selrow, b.editParams), $(c).jqGrid("showAddEditButtons")); });
                    }
                });
            },
        ...
        }), $.jgrid.msie && 8 === $.jgrid.msiever() && ($.expr[":"].hidden = function(a) { return 0 === a.offsetWidth || 0 === a.offsetHeight || "none" === a.style.display; }), $.jgrid._multiselect = !1, $.ui && $.ui.multiselect) {
        ...
        $.ui.multiselect.prototype.destroy && ($.ui.multiselect.prototype.destroy = function() { this.element.show(), this.container.remove(), void 0 === $.Widget ? $.widget.prototype.destroy.apply(this, arguments) : $.Widget.prototype.destroy.apply(this, arguments); }), $.jgrid._multiselect = !0;
    }
    $.jgrid.extend({
        sortableColumns: function(a) {
            return this.each(function() {

                function b() { c.p.disableClick = !0; }
        ...
        columnChooser: function(a) {
            ...
            function c(a, b) { a && ("string" == typeof a ? $.fn[a] && $.fn[a].apply(b, $.makeArray(arguments).slice(2)) : $.isFunction(a) && a.apply(b, $.makeArray(arguments).slice(2))); }

            var d, e, f, g, h, i, j, k = this, l = {}, m = [], n = k.jqGrid("getGridParam", "colModel"), o = k.jqGrid("getGridParam", "colNames"), p = function(a) { return $.ui.multiselect.prototype && a.data($.ui.multiselect.prototype.widgetFullName || $.ui.multiselect.prototype.widgetName) || a.data("ui-multiselect") || a.data("multiselect"); }, q = $.jgrid.getRegional(this[0], "col");
            if (!$("#colchooser_" + $.jgrid.jqID(k[0].p.id)).length) {
                if (d = $('<div id="colchooser_' + k[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), e = $("select", d), a = $.extend({
                    ...
                    apply_perm: function() {
                        var c = [];
                        $("option", e).each(function() { $(this).is("[selected]") ? k.jqGrid("showCol", n[this.value].name) : k.jqGrid("hideCol", n[this.value].name); }), $("option[selected]", e).each(function() { c.push(parseInt(this.value, 10)); }), $.each(c, function() { delete l[n[parseInt(this, 10)].name]; }), $.each(l, function() {
            ...
            return this.each(function() {
                ...
                if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    ...
                    if (a = $.extend({
                        ...
                        autoid: !0,
                        autoidprefix: "dnd_"
                    }, a || {}), a.connectWith) for (a.connectWith = a.connectWith.split(","), a.connectWith = $.map(a.connectWith, function(a) { return $.trim(a); }), $.data(e, "dnd", a), 0 === e.p.reccount || e.p.jqgdnd || b(), e.p.jqgdnd = !0, c = 0; c < a.connectWith.length; c++) d = a.connectWith[c], $(d).droppable($.isFunction(a.drop) ? a.drop.call($(e), a) : a.drop);
                }
            });
        },
        ...
        pivotSetup: function(a, b) {
            ...
            return this.each(function() {
                ...
                if (j.rowTotals && j.yDimension.length > 0) {
                    ...
                    j.yDimension.splice(0, 0, { dataName: y }), j.yDimension[0].converter = function() { return "_r_Totals"; };
                }
        ...
        jqPivot: function(a, b, c, d) {
            return this.each(function() {
                ...
                var f = this;
                "string" == typeof a ? $.ajax($.extend({ url: a, dataType: "json", success: function(a) { e($.jgrid.getAccessor(a, d && d.reader ? d.reader : "rows")); } }, d || {})) : e(a);
            });
        }
    }), $.jgrid.extend({
        setSubGrid: function() {
        ...
        addSubGridCell: function(a, b) {
            var c, d, e, f = "";
            return this.each(function() { f = this.formatCol(a, b), d = this.p.id, c = this.p.subGridOptions.plusicon, e = $.jgrid.styleUI[this.p.styleUI || "jQueryUI"].common; }), '<td role="gridcell" aria-describedby="' + d + '_subgrid" class="ui-sgcollapsed sgcollapsed" ' + f + "><a style='cursor:pointer;' class='ui-sghref'><span class='" + e.icon_base + " " + c + "'></span></a></td>";
        },
                ...
                if (c.grid) {
                    var d, e, f, g, h, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, j = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, k = function(a, b, d) {
                        ...
                        $(g).append(h), a && (f = c.p.xmlReader.subgrid, $(f.root + " " + f.row, a).each(function() {
                            if (h = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), f.repeatitems === !0) $(f.cell, this).each(function(a) { k(h, $(this).text() || "&#160;", a); });
                            else {
                        ...
                        if (!c.grid.hDiv.loading)
                            switch (c.grid.hDiv.loading = !0, $("#load_" + $.jgrid.jqID(c.p.id)).show(), c.p.subgridtype || (c.p.subgridtype = c.p.datatype), $.isFunction(c.p.subgridtype) ? c.p.subgridtype.call(c, d) : c.p.subgridtype = c.p.subgridtype.toLowerCase(), c.p.subgridtype) {
                            case "xml":
                            case "json":
                                $.ajax($.extend({ type: c.p.mtype, url: $.isFunction(c.p.subGridUrl) ? c.p.subGridUrl.call(c, d) : c.p.subGridUrl, dataType: c.p.subgridtype, data: $.isFunction(c.p.serializeSubGridData) ? c.p.serializeSubGridData.call(c, d) : d, complete: function(a) { "xml" === c.p.subgridtype ? l(a.responseXML, b) : m($.jgrid.parse(a.responseText), b), a = null; } }, $.jgrid.ajaxOptions, c.p.ajaxSubgridOptions || {}));
                            }
                        return !1;
                    }, o = 0;
                    $.each(c.p.colModel, function() { (this.hidden === !0 || "rn" === this.name || "cb" === this.name) && o++; });
                    var p = c.rows.length, q = 1;
                    for (void 0 !== b && b > 0 && (q = b, p = b + 1); p > q;)
                        $(c.rows[q]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"), $(c.rows[q].cells[a]).bind("click", function() {
                    ...
                    c.p.subGridOptions.expandOnLoad === !0 && $(c.rows).filter(".jqgrow").each(function(a, b) { $(b.cells[0]).click(); }), c.subGridXml = function(a, b) { l(a, b); }, c.subGridJson = function(a, b) { m(a, b); };
                }
            });
        },
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (e.p.treeGrid) {
                    ...
                    $.each(e.p.treeReader, function(a, b) { b && -1 === $.inArray(b, h) && ("leaf_field" === a && (e.p._treeleafpos = f), f++, e.p.colNames.push(b), e.p.colModel.push({ name: b, width: 1, hidden: !0, sortable: !1, resizable: !1, hidedlg: !0, editable: !0, search: !1 })); });
                }
            });
        },
        ...
        getRootNodes: function(a) {
            ...
            return this.each(function() {
                ...
                if (f.grid && f.p.treeGrid)
                    ...
                    case "nested":
                        c = f.p.treeReader.level_field, $(e).each(function() { parseInt(this[c], 10) === parseInt(f.p.tree_root_level, 10) && b.push(a ? f.p.data[f.p._index[this[f.p.keyName]]] : this); });
                        break;
                    case "adjacency":
                        d = f.p.treeReader.parent_id_field, $(e).each(function() { (null === this[d] || "null" === String(this[d]).toLowerCase()) && b.push(a ? f.p.data[f.p._index[this[f.p.keyName]]] : this); });
                    }
            }), b;
        },
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid)
                    ...
                    case "nested":
                        ...
                        $(this.p.data).each(function() { return parseInt(this[f], 10) === i - 1 && parseInt(this[d], 10) < g && parseInt(this[e], 10) > h ? (b = this, !1) : void 0; });
                        break;
                    case "adjacency":
        ...
        getNodeChildren: function(a) {
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid)
                    ...
                    case "nested":
                        var d = c.p.treeReader.left_field, e = c.p.treeReader.right_field, f = c.p.treeReader.level_field, g = parseInt(a[d], 10), h = parseInt(a[e], 10), i = parseInt(a[f], 10);
                        $(this.p.data).each(function() { parseInt(this[f], 10) === i + 1 && parseInt(this[d], 10) > g && parseInt(this[e], 10) < h && b.push(this); });
                        break;
                    case "adjacency":
                        var j = c.p.treeReader.parent_id_field, k = c.p.localReader.id;
                        $(this.p.data).each(function() { this[j] == $.jgrid.stripPref(c.p.idPrefix, a[k]) && b.push(this); });
                    }
            }), b;
        },
            ...
            return this.each(function() {
                ...
                if (e.grid && e.p.treeGrid)
                    ...
                    case "nested":
                        ...
                        $(this.p.data).each(function() { parseInt(this[i], 10) >= l && parseInt(this[g], 10) >= j && parseInt(this[g], 10) <= k && (b && (this[f] = !0), c.push(this)); });
                        break;
                    case "adjacency":
                        if (a) {
                            c.push(a);
        ...
        getNodeAncestors: function(a) {
            var b = [];
            return this.each(function() { if (this.grid && this.p.treeGrid) for (var c = $(this).jqGrid("getNodeParent", a); c;) b.push(c), c = $(this).jqGrid("getNodeParent", c); }), b;
        },
        isVisibleNode: function(a) {
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    $(d).each(function() { return b = b && this[e], b ? void 0 : !1; });
                }
            }), b;
        },
        ...
        searchTree: function(a) {
            ...
            return this.each(function() { if (this.grid && this.p.treeGrid && e) for (c = this.p.localReader.id, b = 0; e > b; b++) f = $(this).jqGrid("getNodeAncestors", a[b]), f.length || f.push(a[b]), d = f[f.length - 1][c], -1 === $.inArray(d, g) && (g.push(d), f = $(this).jqGrid("getFullTreeNode", f[f.length - 1], !0), h = h.concat(f)); }), h;
        },
    ...
    }), $.fn.jqDrag = function(a) { return i(this, a, "d"); }, $.fn.jqResize = function(a, b) { return i(this, a, "r", b); }, $.jqDnR = {
        dnr: {},
        e: 0,
        drag: function(a) {
    ...
    var J = $.jqDnR, M = J.dnr, E = J.e, E1, M1, i = function(a, b, c, d) {
        return a.each(function() {
            b = b ? $(b, a) : a, b.bind("mousedown", { e: a, k: c }, function(a) {
                ...
                if (M = { X: c.left || f("left") || 0, Y: c.top || f("top") || 0, W: f("width") || E[0].scrollWidth || 0, H: f("height") || E[0].scrollHeight || 0, pX: a.pageX, pY: a.pageY, k: b.k }, M1 = E1 && "d" != b.k ? { X: c.left || f1("left") || 0, Y: c.top || f1("top") || 0, W: E1[0].offsetWidth || f1("width") || 0, H: E1[0].offsetHeight || f1("height") || 0, pX: a.pageX, pY: a.pageY, k: b.k } : !1, $("input.hasDatepicker", E[0])[0])
                    try {
    ...
    }, f = function(a) { return parseInt(E.css(a), 10) || !1; }, f1 = function(a) { return parseInt(E1.css(a), 10) || !1; };
    $.fn.jqm = function(a) {
        ...
        return this.each(function() { return this._jqm ? H[this._jqm].c = $.extend({}, H[this._jqm].c, a) : (s++, this._jqm = s, H[s] = { c: $.extend(b, $.jqm.params, a), a: F, w: $(this).addClass("jqmID" + s), s: s }, void(b.trigger && $(this).jqmAddTrigger(b.trigger))); });
    }, $.fn.jqmAddClose = function(a) { return hs(this, a, "jqmHide"); }, $.fn.jqmAddTrigger = function(a) { return hs(this, a, "jqmShow"); }, $.fn.jqmShow = function(a) { return this.each(function() { $.jqm.open(this._jqm, a); }); }, $.fn.jqmHide = function(a) { return this.each(function() { $.jqm.close(this._jqm, a); }); }, $.jqm = {
        hash: {},
        open: function(a, b) {
            ...
            if (c.a) return F;
            if (c.t = b, c.a = !0, c.w.css("z-index", g), d.modal ? (A[0] || setTimeout(function() { new L("bind"); }, 1), A.push(a)) : d.overlay > 0 ? d.closeoverlay && c.w.jqmAddClose(h) : h = F, c.o = h ? h.addClass(d.overlayClass).prependTo("body") : F, d.ajax) {
                var i = d.target || c.w, j = d.ajax;
                i = "string" == typeof i ? $(i, c.w) : $(i), j = "@" === j.substr(0, 1) ? $(b).attr(j.substring(1)) : j, i.html(d.ajaxText).load(j, function() { d.onLoad && d.onLoad.call(this, c), f && c.w.jqmAddClose($(f, c.w)), e(c); });
    ...
    var s = 0, H = $.jqm.hash, A = [], F = !1, e = function(a) { void 0 === a.c.focusField && (a.c.focusField = 0), a.c.focusField >= 0 && f(a); }, f = function(a) {
        try {
            $(":input:visible", a.w)[parseInt(a.c.focusField, 10)].focus();
        } catch(b) {
        }
    }, L = function(a) { $(document)[a]("keypress", m)[a]("keydown", m)[a]("mousedown", m); }, m = function(a) {
    ...
    $.fmatter = {}, $.extend($.fmatter, { isBoolean: function(a) { return "boolean" == typeof a; }, isObject: function(a) { return a && ("object" == typeof a || $.isFunction(a)) || !1; }, isString: function(a) { return "string" == typeof a; }, isNumber: function(a) { return "number" == typeof a && isFinite(a); }, isValue: function(a) { return this.isObject(a) || this.isString(a) || this.isNumber(a) || this.isBoolean(a); }, isEmpty: function(a) { return !this.isString(a) && this.isValue(a) ? !1 : this.isValue(a) ? (a = $.trim(a).replace(/\&nbsp\;/gi, "").replace(/\&#160\;/gi, ""), "" === a) : !0; } }), $.fn.fmatter = function(a, b, c, d, e) {
        var f = b;
    ...
    }, $.fn.fmatter.defaultFormat = function(a, b) { return $.fmatter.isValue(a) && "" !== a ? a : b.defaultValue || "&#160;"; }, $.fn.fmatter.email = function(a, b) { return $.fmatter.isEmpty(a) ? $.fn.fmatter.defaultFormat(a, b) : '<a href="mailto:' + a + '">' + a + "</a>"; }, $.fn.fmatter.checkbox = function(a, b) {
        ...
        if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
            ...
            if (h && (i = a.split(","), i = $.map(i, function(a) { return $.trim(a); })), $.fmatter.isString(e)) {
                var j, k = e.split(d), l = 0;
                for (j = 0; j < k.length; j++)
                    if (g = k[j].split(c), g.length > 2 && (g[1] = $.map(g, function(a, b) { return b > 0 ? a : void 0; }).join(c)), h) $.inArray(g[0], i) > -1 && (f[l] = g[1], l++);
                    else if ($.trim(g[0]) === $.trim(a)) {
                        f[0] = g[1];
                        break;
                    }
            } else $.fmatter.isObject(e) && (h ? f = $.map(i, function(a) { return e[a]; }) : f[0] = e[a] || "");
        }
        ...
        if (g.value) {
            ...
            if (l && (m = f.split(","), m = $.map(m, function(a) { return $.trim(a); })), $.fmatter.isString(k)) {
                var n, o = k.split(i), p = 0;
                for (n = 0; n < o.length; n++)
                    if (j = o[n].split(h), j.length > 2 && (j[1] = $.map(j, function(a, b) { return b > 0 ? a : void 0; }).join(h)), l) $.inArray($.trim(j[1]), m) > -1 && (e[p] = j[0], p++);
                    else if ($.trim(j[1]) === $.trim(f)) {
                        e[0] = j[0];
                        break;
                    }
            } else
                ($.fmatter.isObject(k) || $.isArray(k)) && (l || (m[0] = f), e = $.map(m, function(a) {
                    var b;
                    return $.each(k, function(c, d) { return d === a ? (b = c, !1) : void 0; }), void 0 !== b ? b : void 0;
                }));
            return e.join(", ");
        }
        return f || "";
        ...
        stringify: function(a) { return JSON.stringify(a, function(a, b) { return "function" == typeof b ? b.toString() : b; }); },
        parse: function(str) { return JSON.parse(str, function(key, value) { return "string" == typeof value && -1 !== value.indexOf("function") ? eval("(" + value + ")") : value; }); },
        encode: function(a) { return String(a).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"); },
                ...
                var addNode = function(hash, key, cnts, val) {
                    ...
                    if (7 !== a.nodeType) {
                        ...
                        if (a.childNodes && a.childNodes.length) {
                            ...
                            else for (c || (c = {}), d = 0; d < a.childNodes.length; d++) e = a.childNodes[d].nodeName, "string" == typeof e && (f = parseElement(a.childNodes[d]), f && ("undefined" == typeof g[e] && (g[e] = 0), g[e]++, addNode(c, e, g[e], f)));
                        }
                        return c;
                    }
