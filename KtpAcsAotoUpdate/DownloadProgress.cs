...
namespace KtpAcsAotoUpdate
{
    public partial class DownloadProgress : Skin_Mac
    {
        ...
        void OnDownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            int t = (int)(int)(nDownloadedTotal * 100 / total);
            this.SetProcessBar(0, t > 100 ? 100 : t);
        ...
        {
            int t = (int)((nDownloadedTotal + e.BytesReceived) * 100 / total);
            this.SetProcessBar(e.ProgressPercentage, t > 100 ? 100 : t);
        }
